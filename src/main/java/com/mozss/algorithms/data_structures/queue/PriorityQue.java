package com.mozss.algorithms.data_structures.queue;

/**
 * @author mozss
 * @create 2019-11-08 22:31
 */
/*
 * 优先级队列
 * insert() 方法，先检查队列中是否有数据项，如果没有，则直接插入到下标为0的单元里，否则，从数组顶部开始比较，
 * 找到比插入值小的位置进行插入，并把 nItems 加1.
 * remove 方法直接获取顶部元素。
